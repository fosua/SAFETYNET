<%-- 
    Document   : donations
    Created on : Nov 23, 2015, 12:55:55 AM
    Author     : estelle
--%>
    ...
    <body>
        ...
        <div class="body_container" id="body_container">
            <div class="welcome-head text-center">
                <h2>Currently seeking Lunch Sponsors</h2>



                <p>If your organization would like to sponsor lunch please contact us.</p>

                <p>To donate to the Clermont County Safety Net Alliance,

                    please contact <b>ccsafetynet@gmail.com</b></p>

                <p>OR</p>

                <p> mail checks to:</p>

                <p> Safety Net Alliance of Clermont County</p>

                <p>C/O Clermont County Community Services</p>

                <p>3003 Hospital Dr.  Batavia, OH 45103</p>
            </div>
