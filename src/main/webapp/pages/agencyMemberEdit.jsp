<%-- 
    Document   : agencyMemberEdit
    Created on : Nov 25, 2015, 3:21:26 AM
    Author     : estelle
--%>
...
<body>
    <div class="body_container">
        ...
        <center>
            ...
            <form class="editMemberForm" id="editMemberForm" method="post" action="<%=request.getContextPath()%>/agency/update" style="margin-top: 20px;">
                <table>
                    <tbody>
                        <tr>
                            <td>Title </td>
                        ...
                        <tr>
                            <td><input type="hidden" name="action" value="1"/><input type="hidden" name="option" value="1"/><input type="hidden" name="id" value="<%=member.getMemberId()%>"/></td>
